  ...
  <div class="balance-management-page">
    ...
    <div class="table-section">
      ...
      >
        ...
        <template #action>
          <a-space>
            <a-button type="text" size="small" @click="$message.info('充值记录开发中')"
              >充值记录</a-button
            >
...
const data = ref([
  {
    ...
    bonus_amount: 100000,
    used_total: 128500,
    last_recharge_at: '2026-04-01',
  },
  {
    id: 2,
    customer_name: 'YY 集团有限公司',
    total_amount: 300000,
    real_amount: 250000,
    bonus_amount: 50000,
    used_total: 85200,
    last_recharge_at: '2026-03-28',
  },
  {
    id: 3,
    customer_name: 'ZZ 创新股份',
    total_amount: 800000,
    real_amount: 700000,
    bonus_amount: 100000,
    used_total: 256800,
    last_recharge_at: '2026-03-25',
  },
])
</script>
